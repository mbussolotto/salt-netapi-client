...
Java bindings for the [Salt API](http://docs.saltstack.com/en/latest/ref/netapi/all/salt.netapi.rest_cherrypy.html#module-salt.netapi.rest_cherrypy.app), please have a look at the Javadoc for [v0.23.0](http://suse.github.io/salt-netapi-client/docs/v0.23.0) or [master](http://suse.github.io/salt-netapi-client/docs/master).
